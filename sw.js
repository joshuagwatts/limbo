/* LIMBO service worker (build 38) — offline-first PWA.
 *
...
/* Same version stamps the page uses (?v=38). query strings are part of
...
const CORE_ASSETS = [
  ...
  './js/audio.js?v=38',
  './js/flock.js?v=38',
  './js/vendor/qrcode.js?v=38',
  './js/vendor/jsqr.js?v=38',
  './assets/realm1.jpg',
  './assets/realm2.jpg',
  './assets/realm3.jpg',
  './assets/realm4.jpg',
