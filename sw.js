/* LIMBO service worker (build 35) — offline-first PWA.
 *
...
/* Same version stamps the page uses (?v=35). query strings are part of
...
const CORE_ASSETS = [
  ...
  './js/audio.js?v=35',
  './js/flock.js?v=35',
  './js/vendor/qrcode.js?v=35',
  './js/vendor/jsqr.js?v=35',
  './assets/realm1.jpg',
  './assets/realm2.jpg',
  './assets/realm3.jpg',
  './assets/realm4.jpg',
