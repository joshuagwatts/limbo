/* LIMBO service worker (build 34) — offline-first PWA.
 *
...
/* Same version stamps the page uses (?v=34). query strings are part of
...
const CORE_ASSETS = [
  ...
  './js/audio.js?v=34',
  './js/flock.js?v=34',
  './js/vendor/qrcode.js?v=34',
  './js/vendor/jsqr.js?v=34',
  './assets/realm1.jpg',
  './assets/realm2.jpg',
  './assets/realm3.jpg',
  './assets/realm4.jpg',
